...
public class RunnerMorning_Podolsk implements Runnable {
	...
	public void run() {
		...
		//  опирование из z_defs в c:\_111, распаковка и копирование в
		// i:\base\price
		{
		...
		//  опирование из z:\sklads с последующей распаковкой в i:\base\price
		AllWork.getListAllSuffix().clear();
		...
		new Done(true, AllWork.getErrorsCount(), AllWork.getFilial()[0], "”тренн€€   ");
